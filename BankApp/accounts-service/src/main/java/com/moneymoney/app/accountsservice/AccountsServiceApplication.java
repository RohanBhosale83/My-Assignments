...
public class AccountsServiceApplication {
	...
	public CommandLineRunner populateData(AccountsRepository accountsRepository) {
		return (arg) -> {
			accountsRepository.save(new SavingsAccount(101,"Rohan",10_000.00,true));
			accountsRepository.save(new SavingsAccount(102,"Shubham",true));
			accountsRepository.save(new SavingsAccount(103,"Tushar",25_000.00,false));
			accountsRepository.save(new CurrentAccount(104,"Tejas",1_00_000.00,5_000.00));
			accountsRepository.save(new CurrentAccount(105,"Ankita",1_00_000.00,5_000.00));
			accountsRepository.save(new CurrentAccount(106,"Deepika",1_00_000.00,5_000.00));
		};
	}
