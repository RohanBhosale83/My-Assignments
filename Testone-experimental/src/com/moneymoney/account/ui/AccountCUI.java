...
public class AccountCUI {
	...
	private static void updateAccount() {
		...
		case 1:
			...
			System.out.println("Enter  choice to update field \n 1.Name \n 2.Salaried?");
			...
			case 1:
				...
				try {
					 SavingsAccount updateAccount = savingsAccountService.updateAccount(accountNumber, userChoice,nameORSalary );
					 System.out.println("Account Holder Name For Account Number "+accountNumber +" is Changed to "+nameORSalary);
				} catch (ClassNotFoundException | SQLException e) {
					 e.printStackTrace();
				}
				break;
			...
			default:
				System.out.println(" Enter new salaried type : true or false ");
				String nameOrSalary = scanner.next();
				 try {
					SavingsAccount updateAccount = savingsAccountService.updateAccount(accountNumber, userChoice,nameOrSalary );
					 System.out.println("Account Type For Account Number "+accountNumber +" is Changed to "+nameOrSalary);
				} catch (ClassNotFoundException | SQLException e) {
					e.printStackTrace();
				}
				break;
		...
		case 2:
			...
			case 1:
				...
				try {
					 CurrentAccount updateAccount = currentAccountService.updateAccount(currentAccountNumber, currentUserChoice,newName );
					 System.out.println("Account Holder Name For Account Number "+currentAccountNumber +" is Changed to "+newName);
				} catch (ClassNotFoundException | SQLException e) {
					 e.printStackTrace();
				}
				break;
