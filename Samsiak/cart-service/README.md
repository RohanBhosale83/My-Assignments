Red Hat Cool Store Microservice Demo [![Build Status](https://travis-ci.org/siamaksade/cart-service.svg?branch=master)](https://travis-ci.org/siamaksade/cart-service)
====================================
...
![Architecture Screenshot](https://raw.githubusercontent.com/jbossdemocentral/coolstore-microservice/stable-ocp-3.4/docs/images/arch-diagram.png "Architecture Diagram")

<img src="https://raw.githubusercontent.com/jbossdemocentral/coolstore-microservice/stable-ocp-3.4/docs/images/store.png" width="740" />
...
![CI/CD Demo](https://raw.githubusercontent.com/jbossdemocentral/coolstore-microservice/stable-ocp-3.4/docs/images/cicd-projects.png)
![CI/CD Demo](https://raw.githubusercontent.com/jbossdemocentral/coolstore-microservice/stable-ocp-3.4/docs/images/cicd-pipeline.png)

Read the [script docs](https://github.com/jbossdemocentral/coolstore-microservice/tree/stable-ocp-3.4/openshift/scripts) for further details and how to run the demo on a local cluster with `oc cluster`.
